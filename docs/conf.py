...
latex_documents = [
    (master_doc, 'dragonfly display.tex', 'dragonfly display Documentation',
...
man_pages = [
    (master_doc, 'dragonfly display', 'dragonfly display Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'dragonfly display', 'dragonfly display Documentation',
     author, 'dragonfly display', 'One line description of project.',
     'Miscellaneous'),
]
